...
if __name__ == "__main__":
    '''
    file_path1 = 'data/depparse/word_dependencies_attn.pkl'  # Replace with your pickle file path
    data1 = load_pickle(file_path1)
    
    #if data1 is not None:
    #    write_to_text(data1, file_path1.replace(".pkl", ".txt"))
    #print("Data1")
    print(data1[42]["words"])
    print(data1[42]["tokens"])
    print(data1[42]["relns"])
    print(data1[42]["heads"])
...
file_path = '/Users/buckethoop/GitHub/attention-analysis/data/depparse/word_dependencies.json'
